...
const id_main_hero = document.getElementById('id_main_hero');
...
function focusOnScroll() {
  sections.forEach(section => section.classList.remove('myclass'));
  if (isElementInViewport(id_main_hero)) {
    ...
    activeSection && activeSection.classList.add('myclass');
